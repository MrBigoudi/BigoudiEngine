...
/**
 * A class representing a 3x2 floating point matrix
*/
class Matrix3x2{
    private:
        /**
        ...
        */
        std::array<std::array<float, 2>, 3> _Values = {
    ...
    public:
        ...
        */
         ...
         * @param matrix The matrix to copy
        */
        void copy(const Matrix3x2& matrix);

        /**
         * A basic constructor
         * @param values The array containing the values
        */
        Matrix3x2(const std::array<std::array<float, 2>, 3>& values);

        /**
         * Create a matrix fill with ones
        */
        static Matrix3x2 ones();

        /**
         * Create a matrix fill with zeros
        */
        static Matrix3x2 zeros();
        ...
        */
        Matrix3x2 operator*(const Matrix2x2& matrix) const;
         ...
         * @return The resulting matrix
        */
        Matrix3x3 operator*(const Matrix2x3& matrix) const;
         ...
         * @return The resulting matrix
        */
        Matrix3x4 operator*(const Matrix2x4& matrix) const;
};
