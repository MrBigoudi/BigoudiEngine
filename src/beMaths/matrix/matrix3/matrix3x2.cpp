...
*/
Matrix3x2& Matrix3x2::operator=(const Matrix3x2& matrix){
    copy(matrix);
    return *this;
}
 ...
 * @param matrix The matrix to copy
*/
void Matrix3x2::copy(const Matrix3x2& matrix){
...
*/
Matrix3x2::Matrix3x2(const std::array<std::array<float, 2>, 3>& values){
    _Values = values;
}
...
*/
Matrix3x2 Matrix3x2::ones(){
    return Matrix3x2(1.f);
}

/**
 * Create a matrix fill with zeros
*/
Matrix3x2 Matrix3x2::zeros(){
    return Matrix3x2();
}
 ...
 * @return The string
*/
const std::string Matrix3x2::toString() const{
    std::string str = "{";
...
std::array<float, 2> Matrix3x2::operator[](int index) const{
    if(index < 0 || index >= static_cast<int>(_Values.size())){
        fprintf(stderr, "Index %d out of range for Matrix3x2!\n", index);
 ...
 * @param matrix The second matrix
*/
void Matrix3x2::operator+=(const Matrix3x2& matrix){
    for(size_t i = 0; i<_Values.size(); i++){
        for(size_t j = 0; j<_Values[0].size(); j++){
 ...
 * @param matrix The second matrix
*/
void Matrix3x2::operator*=(const Matrix2x2& matrix){
    Matrix3x2 newMat{};
    for(size_t i = 0; i<_Values.size(); i++){
        for(size_t j = 0; j<_Values[0].size(); j++){
...
*/
Vector3 Matrix3x2::operator*(const Vector2& vector) const{
    Vector3 newVector{};
    for(size_t i = 0; i<_Values.size(); i++){
        for(size_t j = 0; j<_Values[0].size(); j++){
...
*/
Matrix3x2 Matrix3x2::operator*(const Matrix2x2& matrix) const{
    Matrix3x2 newMat{};
    for(size_t i = 0; i<_Values.size(); i++){
 ...
 * @return The resulting matrix
*/
Matrix3x3 Matrix3x2::operator*(const Matrix2x3& matrix) const{
    Matrix3x3 newMat{};
    for(size_t i = 0; i<_Values.size(); i++){
 ...
 * @return The resulting matrix
*/
Matrix3x4 Matrix3x2::operator*(const Matrix2x4& matrix) const{
    Matrix3x4 newMat{};
    for(size_t i = 0; i<_Values.size(); i++){
